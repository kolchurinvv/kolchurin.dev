...
<main>
  <section class="section">
    <div class="container">
      ...
      <div class="card">
        <p class="about-text">
          I specialize in building <span class="highlight"
            >resilient backend architectures</span
          ...
          mindset, I excel at solving complex synchronization and infrastructure
          challenges—moving beyond the UI to engineer robust, high-performance systems.
        </p>
        <div class="stats">
          <div class="stat">
      ...
      <div class="grid">
        <article class="card project-card">
          ...
          <ul class="project-highlights">
            ...
            <li>
              Secure routing between public VPS services and private Ollama via
              WireGuard
            </li>
            <li>
              Tool-augmented local inference with Open-WebUI + external search
              APIs
            </li>
        ...
        <article class="card project-card">
          ...
          <ul class="project-highlights">
            <li>
              Reproducible dev environment using Nix Flakes with NVIDIA drivers
              & GPU-accelerated Android emulators
            </li>
            <li>
              Portable container orchestration with Podman-compose across NixOS
              and macOS
            </li>
          </ul>
        </article>
    ...
    <div class="container">
      <div class="section-header">
        <span class="section-icon">
          <i class="extra">workspace_premium</i>
        </span>
...
<footer class="footer">
  <div class="container">
    <div class="footer-content">
      ...
      <p>
        &copy; {new Date().getFullYear()} Vladimir Kolchurin. Built with SvelteKit.
      </p>
    </div>
  </div>
</footer>
